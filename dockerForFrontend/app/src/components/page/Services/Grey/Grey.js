...
const API = process.env.REACT_APP_API_GRAY;
...
export const Grey = () => {
  ...
  const handleUploadImage = async (event) =>  {
          ...
          fetch(`${API}/gray`, { method: 'POST', body: d, headers: {
      ...
      {(
          ...
          <section className="main-home" id="home">
              ...
              <div className="home__header-content">
                  <h1 className="intro-title">Grey</h1>
                  ...
                  <svg id="SVG6" enableBackground="0 0 578.405 578.405" height="80" viewBox="0 0 578.405 578.405" width="80" xmlns="http://www.w3.org/2000/svg"><g><path d="M289.203,0C129.736,0,0,129.736,0,289.203C0,448.67,129.736,578.405,289.203,578.405
  			c159.467,0,289.202-129.735,289.202-289.202C578.405,129.736,448.67,0,289.203,0z M28.56,289.202
  			C28.56,145.48,145.481,28.56,289.203,28.56l0,0v521.286l0,0C145.485,549.846,28.56,432.925,28.56,289.202z"/></g></svg></div>
          </section>
              ...
              <div className="container">
                  <div className="row">
                      <div className="col-md-12">
                          <h3 className="title text-center">Grey</h3>
